...
volatile uint32_t pwm_curr;
volatile uint32_t ovf_count_pwm;
volatile uint32_t ovf_count_rgb_trans;
volatile uint32_t ovf_count_button;
volatile uint32_t button_hold_curr;
...
int main() {
  ...
  */
  ...
  uint8_t button_state_curr = 0;
  uint8_t button_state_last = 0;
